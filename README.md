...
bash <(curl -sL [https://raw.githubusercontent.com/licong87/你的仓库名/traffic-monitor/traffic-monitor.sh](https://raw.githubusercontent.com/你的用户名/你的仓库名/main/dmit-traffic-monitor.sh))
```
